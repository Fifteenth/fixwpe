 ...
 *
 */
public class SelectBizobjForServiceWizardPage extends WizardPage {
	 ...
	 * @param pageName
	 */
	public SelectBizobjForServiceWizardPage(String pageName) {
		super(pageName);
	 ...
	 * @param titleImage
	 */
	public SelectBizobjForServiceWizardPage(String pageName, String title,
