 ...
 *
 */
public class SelectBizobjServiceWizardPage extends WizardPage {
	 ...
	 * @param pageName
	 */
	public SelectBizobjServiceWizardPage(String pageName) {
		super(pageName);
	 ...
	 * @param titleImage
	 */
	public SelectBizobjServiceWizardPage(String pageName, String title,
		...
		//消息信息
		setMessage("请选择业务对象下的方法", INFORMATION);
	...
	public void createControl(Composite parent) {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseDown(MouseEvent e) {
				...
				if (value != null) {
					//将值交给下一个页面
//					((SelectBizobjAndServiceWizard) getWizard()).getSelectBizobjServiceWizardPage().setBizobjEntity(value);
	...
	public void setBizobjEntity(BizobjEntity viewEntity) {
		...
		List<ObjServiceTo> objServices = AppUtil.getObjServicesFromBizobjId(viewEntity.getId());
		if(objServices != null && objServices.size() > 0) {
			for (Iterator iterator = objServices.iterator(); iterator.hasNext();) {
				ObjServiceTo objServiceTo = (ObjServiceTo) iterator.next();
				BizobjEntity entity = new BizobjEntity();
				entity.setId(objServiceTo.getId());
				entity.setName(objServiceTo.getName());
				entities.add(entity);
			}
		}
