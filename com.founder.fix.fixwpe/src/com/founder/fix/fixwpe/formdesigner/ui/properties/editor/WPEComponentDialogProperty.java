...
import com.founder.fix.studio.formdesigner.adapter.tree.HtmlNodePropertySource;
...
import com.founder.fix.studio.formdesigner.ui.properties.editor.FixComboBoxPropertyDescriptor;
import com.founder.fix.studio.formdesigner.ui.properties.editor.FixTextPropertyDescriptor;
...
//				.getProperty(this.elementInfo.name, id.toString());
		...
		Map<String, Object> prop = AbstractTagCreatorProvider.getXMLProperty(this.elementInfo.name, id.toString());
